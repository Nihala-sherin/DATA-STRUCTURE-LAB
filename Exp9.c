#include<stdio.h>
#include<stdlib.h>
int superSet[20],superSetSize=0,setA[20],setASize=0,setB[20];
int setBSize=0,bitStringA[20],bitStringB[20],bitStringUnion[20];
int bitStringIntersection[20],bitStringDifference[20];
